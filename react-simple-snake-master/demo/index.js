...
ReactDOM.render(
  <React.StrictMode>
    ...
    <div className="textWrapper">
      ...
      <p className="subTitle">A simple snake game created with the React 
      {/* <a href="https://reactjs.org/" target="_blank" rel="noopener noreferrer"> React </a> */}   JavaScript library</p>
    </div>
    <SnakeGame />
  </React.StrictMode>,
